...
class UserController extends Controller
{
    ...
    public function store(UserStoreRequest $request)
    {
        ...
        return redirect()->route('users.index')->with('message', 'User has been registered successfully!');
    }
    ...
    public function destroy(User $user)
    {
        if ($user->id == auth()->user()->id){
            return redirect()->route('users.index')->with('message', 'You may not delete the currently logged in user');
        }
        $user->delete();
